...
<form action="" method="post">
    ...
    <div class="form-group my-2">
        ...
        <input name="precor_validez_oferta" id="precor_validez_oferta" class="form-control w-75" placeholder="Ejm: 08 DIAS" value="<?= get_option('precor_validez_oferta') ?>">
    </div>
    ...
    <div class="form-group my-2">
        ...
        <input name="precor_text_no_hay_stock" id="precor_text_no_hay_stock" class="form-control w-75" placeholder="No hay stock para @nombre_producto, por favor contacte con su ejecutivo de ventas." value="<?= get_option('precor_text_no_hay_stock') ?>">
    </div>
    <br>
    <div class="form-group my-2">
        ...
        <input name="precor_emails_reclamos" id="precor_emails_reclamos" class="form-control w-75" placeholder="pepito@gmail.com" value="<?= get_option('precor_emails_reclamos') ?>">
    </div>
    <br>
