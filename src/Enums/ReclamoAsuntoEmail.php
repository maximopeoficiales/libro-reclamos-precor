...
abstract class  ReclamoAsuntoEmail
{
    ...
    const RECHAZADO_CONFIRMADO_POR_CLIENTE = "Haz aceptado la repuesta del Reclamo / Queja";
    ...
    const ACEPTADO_CONFIRMADO_POR_CLIENTE = "Haz aceptado la repuesta del Reclamo / Queja";
